...
write.table(coverage_df,file = paste(out_folder,"coverage_bbmap_summary.tsv",sep = ""), sep = "\t", quote = F,row.names = F)
pdf(file = paste(out_folder,"coverage_bbmap_hist.pdf",sep = ""), width = 15, height = 10)
